...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.view_control = QSofaViewKeyboardController(translate_rate_limit=0.5, rotate_rate_limit=5, update_rate=20)
        ...
        self.mat_engine = EngineORB(mat_dir=self.mat_dir,
                                    skip_images_init=4, 
                                    skip_images_main=2, 
